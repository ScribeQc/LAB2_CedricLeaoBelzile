        ...
        if (collision.gameObject.tag == "Player")
        {
            ...
            if (indexScene == 2)
            {
               ...
               float _tempsNiveau3 = Time.time - _tempsNiveau2-_tempsNiveau1;
                ...
                Debug.Log("Obstacles accroch� au niveau 1 : " + _accrochagesNiveau1);
                ...
                Debug.Log("Obstacles accroch� au niveau 2 : " + _accrochagesNiveau2);
                ...
                Debug.Log("Obstacles accroch� au niveau 3 : " + _accrochagesNiveau3);
